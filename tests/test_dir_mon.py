...
class TestDirMon(unittest.TestCase):
    ...
    def test_get_new_files(self):
        ...
        self.assertListEqual(res_d['new_files'], ['test1.png', 'test2.jpg'])
    ...
    def test_hold_filter(self):
        ...
        self.assertListEqual(res_d['new_files'], ['test1.png'])
        self.assertListEqual(res_d['hold_files'], ['hold-test2.png'])
